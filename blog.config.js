...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CangW', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一個普通的大學生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cangw.eu.org', // 网站地址
